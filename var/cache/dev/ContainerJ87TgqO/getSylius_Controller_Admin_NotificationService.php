...
class getSylius_Controller_Admin_NotificationService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.controller.admin.notification'] = new \Sylius\Bundle\AdminBundle\Controller\NotificationController(($container->privates['sylius.http_client'] ??= new \GuzzleHttp\Client()), new \Http\Message\MessageFactory\GuzzleMessageFactory(), 'https://gus.sylius.com/version', 'dev');
    }
}
