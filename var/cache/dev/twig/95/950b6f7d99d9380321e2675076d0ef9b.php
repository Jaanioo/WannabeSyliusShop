...
class __TwigTemplate_5d9d4db753d4182fc9fe8d5f2aa8ddd7 extends Template
{
    private $source;
    private $macros = [];
...
{% block icon %}
    ...
    {% if icon %}<i class=\"icon {{ icon }}\"></i> {% endif %}
{% endblock %}
", "@SyliusUi/Menu/top.html.twig", "/Users/janek/Desktop/Programowanie/SyliusShopTrial/SyliusTrailShop/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Menu/top.html.twig");
    }
}
