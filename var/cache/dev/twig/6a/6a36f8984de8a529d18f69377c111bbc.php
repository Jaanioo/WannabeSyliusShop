...
class __TwigTemplate_95923c1e89df854ec01af073b89e04aa extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_formField($__item__ = null, $__count__ = null, $__id__ = null, $__prefix__ = null, $__subject__ = null, $__applicationName__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            // line 63
            echo "    ";
            $macros["__internal_parse_40"] = $this;
            // line 64
            echo "    ";
...
{% macro formField(item, count, id, prefix, subject, applicationName) %}
    ...
    {% endif %}
{% endmacro %}
", "@SyliusAdmin/Product/Attribute/attributeValues.html.twig", "/Users/janek/Desktop/Programowanie/SyliusShopTrial/SyliusTrailShop/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/Attribute/attributeValues.html.twig");
    }
}
