...
class __TwigTemplate_7f3c5a5661e8e88556fb23b50088359e extends Template
{
    private $source;
    private $macros = [];
...
{% if sylius_bundle_loaded_checker('SyliusShopBundle') %}
    ...
    {% endif %}
{% endif %}
", "@SyliusAdmin/Product/_showInShopButton.html.twig", "/Users/janek/Desktop/Programowanie/SyliusShopTrial/SyliusTrailShop/vendor/sylius/sylius/src/Sylius/Bundle/AdminBundle/Resources/views/Product/_showInShopButton.html.twig");
    }
}
