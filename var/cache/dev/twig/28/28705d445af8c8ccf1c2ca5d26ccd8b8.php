...
class __TwigTemplate_f75b7d8710d4328e4faafa93705586f3 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_collection_widget($context, array $blocks = [])
    {
        ...
        // line 81
        $macros["__internal_parse_6"] = $this->loadTemplate("@SyliusResource/Macros/notification.html.twig", "@SyliusUi/Form/theme.html.twig", 81)->unwrap();
        // line 82
        echo "    ";
        $macros["self"] = $this;
        // line 83
    ...
    ";
        ...
        echo ">
            ";
        // line 92
        echo twig_call_macro($macros["__internal_parse_6"], "macro_error", [twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 92, $this->source); })()), "vars", [], "any", false, false, false, 92), "errors", [], "any", false, false, false, 92)], 92, $context, $this->getSourceContext());
        echo "

            ";
        // line 94
        if (is_iterable(((array_key_exists("prototypes", $context)) ? (_twig_default_filter((isset($context["prototypes"]) || array_key_exists("prototypes", $context) ? $context["prototypes"] : (function () { throw new RuntimeError('Variable "prototypes" does not exist.', 94, $this->source); })()))) : ("")))) {
            // line 95
            echo "                ";
            $context['_parent'] = $context;
...
";
    ...
    public function block_sylius_resource_autocomplete_choice_row($context, array $blocks = [])
    {
        ...
        if ((isset($context["disabled"]) || array_key_exists("disabled", $context) ? $context["disabled"] : (function () { throw new RuntimeError('Variable "disabled" does not exist.', 202, $this->source); })())) {
            echo "disabled ";
        }
        echo "field";
...
{% block sylius_image_widget %}
    ...
    {% endapply %}
{% endblock %}
", "@SyliusUi/Form/theme.html.twig", "/Users/janek/Desktop/Programowanie/SyliusShopTrial/SyliusTrailShop/vendor/sylius/sylius/src/Sylius/Bundle/UiBundle/Resources/views/Form/theme.html.twig");
    }
}
