...
class getSylius_AdminUser_PinGenerator_PasswordResetService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['sylius.admin_user.pin_generator.password_reset'] = new \Sylius\Component\User\Security\Generator\UniquePinGenerator(($container->services['sylius.random_generator'] ??= new \Sylius\Component\Resource\Generator\RandomnessGenerator()), new \Sylius\Component\User\Security\Checker\TokenUniquenessChecker(($container->services['sylius.repository.admin_user'] ?? $container->load('getSylius_Repository_AdminUserService')), 'passwordResetToken'), 4);
    }
}
